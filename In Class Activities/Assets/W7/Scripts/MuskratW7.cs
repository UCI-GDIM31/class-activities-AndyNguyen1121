...
public class MuskratW7 : MonoBehaviour
{
    ...
    private void MoveOrbitMode()
    {
        ...
        Vector3 worldDir = transform.TransformDirection(transform.up);
        transform.RotateAround(_sphereTransform.position, worldDir, leftright * _rotationSpeed * Time.deltaTime);
    ...
    private void MoveNormal()
    {
        ...
        _animator.SetBool("flying", Mathf.Abs(_rigidbody.linearVelocity.y) > 0.05f);
        _animator.SetBool("running", Mathf.Abs(_rigidbody.linearVelocity.z) > 0);   
